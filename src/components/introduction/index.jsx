...
let styles = {
  section: "flex flex-col lg:grid lg:grid-cols-2 min-h-screen",
  ...
  div2span: "fontFjallaOne text-3xl font-bold text-[] pl-1 lg:text-5xl",
  div3: "fontArchivoBlack pt-6 text-3xl text-[#1FC3FF] lg:text-7xl",
