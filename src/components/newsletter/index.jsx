...
const Newsletter = () => {
  return (
    <>
      <section className="flex justify-center lg:ml-20">
        <div class="w-full max-w-2xl px-6 py-4 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
          ...
          <div class="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
            <div class="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-300 transform rounded-md dark:text-gray-200">
              <svg
                class="w-5 h-5"
            ...
            <div class="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-300 transform rounded-md dark:text-gray-200">
              ...
              <span class="mt-2">+33751058507</span>
            </div>
            ...
            <div class="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-300 transform rounded-md dark:text-gray-200">
              ...
              <span class="mt-2">safwan7342@gmail.com</span>
            </div>
          </div>
